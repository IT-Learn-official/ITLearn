...
const Prism = ({
  ...
  // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: shader setup
  useEffect(() => {
    ...
    const INERT = clamp(inertia || 0.12, 0, 1);
    ...
    // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: render loop
